...
public class AllPointsOnMap {
    ...
    @Expose
    private AllPointsOnMap.State state;
    ...
    public AllPointsOnMap.State getState() {
        return state;
    }

    public void setState(AllPointsOnMap.State state) {
        this.state = state;
    }
    ...
    public enum State {
        ...
        private final static Map<String, AllPointsOnMap.State> CONSTANTS = new HashMap<String, AllPointsOnMap.State>();

        static {
            for (AllPointsOnMap.State c: values()) {
